...
exports.default = function () {
	var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(message) {
		...
		var parserOptions, _options$configuratio, rules, wildcards, parsed, bails, results, errors, warnings, valid;

		return _regenerator2.default.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						parserOptions = options.preset.parserOpts, _options$configuratio = options.configuration, rules = _options$configuratio.rules, wildcards = _options$configuratio.wildcards;

						// parse the commit message

						parsed = (0, _lodash.merge)({ raw: message }, (0, _conventionalCommitsParser.sync)(message, parserOptions));

						// wildcard matches skip the linting

						bails = Object.entries(wildcards).filter(function (entry) {
							...
							var expression = new (Function.prototype.bind.apply(RegExp, [null].concat((0, _toConsumableArray3.default)(pattern))))();
					...
					case 5:
						...
						results = Object.entries(rules).filter(function (entry) {
							var _entry3 = (0, _slicedToArray3.default)(entry, 2),
							    _entry3$ = (0, _slicedToArray3.default)(_entry3[1], 1),
							    level = _entry3$[0];

							return level > 0;
						}).map(function (entry) {
							var _entry4 = (0, _slicedToArray3.default)(entry, 2),
							    name = _entry4[0],
							    config = _entry4[1];

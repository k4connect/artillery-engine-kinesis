...
exports.default = function (parsed, when, value) {
	...
	var _ensureTense = (0, _ensureTense3.default)(parsed.subject, value),
	...
	return [negated ? !matches : matches, [`tense of message must`, negated ? `not` : null, `be ${value}. Verbs in other tenses: ${offenders}`].filter(Boolean).join(' ')];
};

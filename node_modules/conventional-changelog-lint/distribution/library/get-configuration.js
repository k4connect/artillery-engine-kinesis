			...
			while (1) {
				switch (_context3.prev = _context3.next) {
									...
									while (1) {
										switch (_context2.prev = _context2.next) {
											case 0:
												...
												_context2.next = 3;
												return Promise.all(Object.entries(value || {}).map(function () {
													var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(entry) {
											...
											case 3:
												executedValue = _context2.sent;
												return _context2.abrupt('return', [key, executedValue.reduce(function (registry, item) {
					...
					case 8:
						...
						return _context3.abrupt('return', executed.reduce(function (registry, item) {
